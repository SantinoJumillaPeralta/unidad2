...
public:
	Cubo(b2World* _world, RenderWindow* _wnd)
	{
		...
		wnd = _wnd;
		_image = new Texture();
		_image->loadFromFile("cubo.jpg"); // Cambié la textura a una representativa de un cubo
		// Cargamos el sprite
		...
		dynamicBox.SetAsBox(20.0f, 20.0f); // Cambié el tamaño para representar un cubo
